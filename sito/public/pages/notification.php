...
<section class="notifications_section">
    <?php if (login_check($mysqli)) : ?>
        ...
        <?php endif; ?>
    <?php else : ?>
        <h2 class="cool_title" >Devi loggare per visualizzare questa pagina!</h2>
