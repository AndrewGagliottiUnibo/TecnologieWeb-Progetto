...
<section class="evidenza">
        ...
        <ul>
            <?php foreach ($products as $product) : ?>
                ...
                <li class="card">
                    ...
                    <div class="text">
                        <h4><a href="<?php echo ROOT_URL . "shop/?page=product&id=" . $product->id ?>"><?php echo $product->name ?></a>
                        </h4>
    ...
    <a class="commit_button" href="<?php echo ROOT_URL; ?>shop?page=catalogo">Vai al catalogo</a>
</section>